...
CREATE TABLE `comentario`(`id_comentario` INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,`comentario` VARCHAR(200) NOT NULL,`puntaje` INT(11) NOT NULL,`fk_id_producto` INT(11) NOT NULL,FOREIGN KEY (`fk_id_producto`) REFERENCES `producto`(`id_producto`) ON DELETE CASCADE);
